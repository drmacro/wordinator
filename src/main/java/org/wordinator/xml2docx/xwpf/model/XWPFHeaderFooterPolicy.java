...
==================================================================== */
package org.wordinator.xml2docx.xwpf.model;
 ...
 */
public class XWPFHeaderFooterPolicy extends org.apache.poi.xwpf.model.XWPFHeaderFooterPolicy {
     ...
     * as required.
     * <p>Headers and footers will be set as the document-level headers
     * and footers</p>
     * @param doc Document to create headers and footers in
     */
     ...
     * as required.
     * @param doc Document to create headers and footers in
     * @param sectPr Section properties to attach headers and footers
     * to. If null uses document's section properties. Specify 
     * a section's properties to set headers and footers for the section.
     */
